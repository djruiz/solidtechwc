  ...
  return (
    <div className="text-light">
      <div style={{ width: "100vw", minHeight: "100vh" }} className="bg-dark">
        <div
          style={{ filter: "drop-shadow(5px 5px 5px #00000050)" }}
          className="text-center pt-4 d-flex justify-content-center w-100"
        >
          <div className="pt-4 text-center d-flex align-items-center flex-column">
            <h1 className="marker">Solid Tech</h1>
            <h2
              className="marker pb-2 text-danger"
              style={{ fontSize: "20px" }}
            >
              Wrestling Club
            </h2>
        ...
        <div className="mx-auto px-4 py-4" style={{ maxWidth: "600px" }}>
          ...
          <div className="row">
            <div className="col col-12 col-md-4 text-center">
              ...
              <p>
                <b className="underline">Lorem</b> ipsum dolor sit amet,
          ...
          <div className="text-center pt-4">
            ...
            <small>
              <i>Classes starting at $99/session!</i>
            </small>
          </div>
        </div>
      </div>
      <div
        className="bg-danger text-light inset-shadow"
